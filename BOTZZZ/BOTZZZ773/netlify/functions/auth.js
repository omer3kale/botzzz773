...
async function handleSignup({ email, password, username, firstName, lastName }, headers) {
  try {
    ...
    // Create welcome ticket for new user
    try {
      console.log('[WELCOME TICKET] Creating ticket for user:', newUser.id);
      
      // Generate ticket number with TCK- prefix (e.g., TCK-HB3NSV7FA959)
...
🌐 Website: www.botzzz773.pro`,
        ...
        console.log('[WELCOME TICKET] No ticket data returned');
      }
    } catch (err) {
